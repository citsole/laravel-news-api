                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="firstname" value="{{$emp->firstname}}" placeholder="ຊື່ພະນັກງານ">
                              </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="lastname">ນາມສະກຸນ</label>
                                <input type="text" class="form-control" name="lastname" value="{{$emp->lastname}}" placeholder="ນາມສະກຸນ">
                              </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="phone" value="{{$emp->phone}}" placeholder="ເບີ້ໂທລະສັບ">
                              </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="address">ທີ່ຢູ່ປະຈຸບັນ</label>
                                <input type="text" class="form-control" name="address" value="{{$emp->address}}" placeholder="ທີ່ຢູ່ປະຈຸບັນ">
                              </div>
                        </div>
                    </div>
